<%-- 
    ...
    Created on : 10-07-2019, 19:56:48
    Author     : Fox
--%>
...
<html>
    ...
    <center><h3>Ventas en rangos de fechas especificadas</h3></center>
    <div class="container">
    ...
    <div class="container">
        <table class="striped">
            ...
            <tbody>
                <%
                    String msgRango1 = (String) session.getAttribute("servletMsgRango1");
                    String msgRango2 = (String) session.getAttribute("servletMsgRango2");
                    VentaDAO vdao = new VentaDAO();
                    ArrayList<Venta> ventas = vdao.buscarRango(msgRango1, msgRango2);
                    if (ventas != null) {
                        for (Venta v : ventas) {
                            out.println("<tr>");
