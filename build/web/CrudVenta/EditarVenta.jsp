                ...
                <div class="col s8 offset-s2"> 
                    <div class="container white">
                        <table class="highlight-4 responsive-table centered">
                            ...
                            <c:forEach var = "row" items = "${ventas.rows}">
                                <tr>
                                    <td> <c:out value = "${row.folioventa}"/></td>
                                    <td> <c:out value = "${row.fecha}"/></td>
                                    <td> <c:out value = "${row.hora}"/></td>
                                    <td> <c:out value = "${row.nroboleta}"/></td>
                                    ...
                                    <td><form action="<c:out value="${pageContext.request.contextPath}"></c:out>/ControladorVenta" method="POST" ><input type="hidden" name="folioventa" value="<c:out value="${row.folioventa}"></c:out>"></input><input type="submit" value="Buscar" name="opcion"></input></form></td>
