                        ...
                        <table class="highlight-4 responsive-table centered">
                            ...
                            <c:forEach var = "row" items = "${clientes.rows}">
                                <tr>
                                    ...
                                    <td><form action="<c:out value="${pageContext.request.contextPath}"></c:out>/ControladorCliente" method="POST" ><input type="hidden" name="id_cliente" value="<c:out value="${row.id_cliente}"></c:out>"></input><input type="submit" value="Buscar" name="opcion"></input></form></td>
