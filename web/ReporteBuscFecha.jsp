...
<html>
    ...
    <center><h3>Venta en fecha especificada</h3></center>
    <div class="container">
...
<div class="container">
    <table class="striped">
        ...
        <tbody>
            <%
                String msgfecha = (String) session.getAttribute("servletMsgFecha");
                VentaDAO vdao = new VentaDAO();
                ArrayList<Venta> ventas = vdao.buscarFecha(msgfecha);
                if (ventas != null) {
                    for (Venta v : ventas) {
                        out.println("<tr>");
