        ...
        <form action="${pageContext.request.contextPath}/ControladorCliente" method="POST" >
            <div class="row">
                <div class="col s8 offset-s2">
                    <table>
                        <tr>
                            <td>Id Cliente:</td><td> <input   type="Text" name="id_cliente" value="1"></input></td>
                        </tr>
                        <tr>
                            <td>Nombre:</td><td><input type="Text" name="nombre"></input></td>
                        </tr>
                        <tr>
                            <td>Apellido Pat.:</td><td><input   type="Text" name="apellidoP"></input></td>
                        </tr>
                        <tr>
                            <td>Apellido Mat.:</td><td><input   type="Text" name="apellidoM"></input></td>
                        </tr>
                        <tr>
