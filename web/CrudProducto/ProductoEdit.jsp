    ...
    <body>
        ...
        <nav>
            ...
            <div class="col s8 offset-s2"> 
                <table>
                    <tr>
                        <td>Id Producto:</td><td> <input   type="Text" name="id_producto" value="<c:out value="${sessionScope.productobuscado.idProducto}"></c:out>"></input></td>
                        </tr>
                        <tr>
                            <td>Nombre:</td><td><input type="Text" name="nombre" value="<c:out value="${sessionScope.productobuscado.nombre}"></c:out>"></input></td>
                        </tr>
                        <tr>
                            <td>Precio:</td><td><input   type="Text" name="precio" value="<c:out value="${sessionScope.productobuscado.precio}"></c:out>"></input></td>
                        </tr>
                        <tr>
                            <td>Stock:</td><td><input   type="Text" name="stock" value="<c:out value="${sessionScope.productobuscado.stock}"></c:out>"></input></td>
                    </tr>
